...
import HolidayMasterList from '../Component/HolidayMasterList';
import ViewLeaveApprovalList from './ViewLeaveApprovalList';

function ViewLeaveApproval() {
      ...
      <Grid container spacing={2}>
       ...
       View Leave Approval
        ...
        <Grid item xs={3} textAlign={'right'}>
            ...
            <Typography color="text.primary">  Leave Approval</Typography>
          </Breadcrumbs>
        </div>
        </Grid>
      </Grid>
...
export default ViewLeaveApproval
